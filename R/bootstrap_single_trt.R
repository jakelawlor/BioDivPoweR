...
bootstrap_single_trt <- function(pilot,
  ...
  # rarefy bootstraps to equal maximum coverage
  rarefied_boots <- .rarefy_boots(boot_arrays, eff_coverage,  "single")
  ...
  p3 <- .plot_boots_log2_diff(summary,
                              n_eff_size_bins = n_eff_size_bins,
                              min_exp_n = min_exp_n)
  print(p3)
